...
/**
 * Created by Nikhil on 5/26/2017.
 */
...
public class URLMediaPlayerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final String audioFile = intent.getStringExtra(Mediaplayer.AUDIO_URL);
        final String coverImage = intent.getStringExtra(Mediaplayer.IMG_URL);
