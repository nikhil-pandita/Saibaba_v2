...
public class GridViewAdapter_IMG extends BaseAdapter {
    ...
    ArrayList<HashMap<String, String>> Img = new ArrayList<HashMap<String,String>>();
    ImageLoader imageLoader;
    DisplayImageOptions options;


    public GridViewAdapter_IMG(ArrayList<HashMap<String, String>> result ,Context context) {
        Img = result;
        cont = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        imageLoader.displayImage(Img.get(position).get("URL"), iv);
        return view;
